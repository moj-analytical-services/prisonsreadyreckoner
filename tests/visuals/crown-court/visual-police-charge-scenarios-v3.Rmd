...
compare_disposals <- function(cc_disposals_delta_actual, target_central, path_target_scenario, params) {
  ...
  target_scenario <- import_s3_file(path_target_scenario) %>%
    ...
    dplyr::summarise(n_disposals = sum(.data$n_disposals), .groups = "drop")
  # target_scenario <- import_s3_file(path_target_scenario) %>%
  #   dplyr::rename(route = "actual_route") %>%
...
path_target_high <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_sep23_v1/model_outputs/adjustments/sensitivity_sd_scaled_v2_231006_0932/crown-output-sep23_s1.csv"   # '20231113 - Bayley Cartmell - Re_ Alternative cc_output tables_.msg'
path_target_low <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_sep23_v1/model_outputs/adjustments/sensitivity_sd_scaled_v2_231006_0932/crown-output-sep23_s3.csv"   # '20231113 - Bayley Cartmell - Re_ Alternative cc_output tables_.msg'
# path_target_high <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_sep23_v1/model_outputs/adjustments/sensitivity_sd_scaled_v2_231006_0932/crown-output-os_adj_hmcts-sep23_s1.csv"   # '20231110 - Bayley Cartmell - Re_ Alternative cc_output tables_.msg'
# path_target_low <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_sep23_v1/model_outputs/adjustments/sensitivity_sd_scaled_v2_231006_0932/crown-output-os_adj_hmcts-sep23_s3.csv"   # '20231110 - Bayley Cartmell - Re_ Alternative cc_output tables_.msg'
