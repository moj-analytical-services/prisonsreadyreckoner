...
set_crown_params <- function() {
  ...
  params$lever_police_charges_scenario           <- "apr23_central" #"ramp_48m"
...
# NOTE: THIS FUNCTIONALITY WAS LATER ADDED TO THE PACKAGE FUNCTION BUT IS LEFT
# HERE FOR CONVENIENCE.
load_crown_data_test <- function(cc_output_file, cc_capacity_file, ringfenced_lookup, start_date, forecast_start_date, forecast_end_date) {
...
cc_data <- load_crown_data_test(params$cc_output_file, params$cc_capacity_file, ringfenced_lookup, params$start_date$cc_files, params$forecast_start_date, params$forecast_end_date)
