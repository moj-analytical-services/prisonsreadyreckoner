...
scenario files, as provided by the Courts Team, the forecast Crown Court
...
path_target_high <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_RR_receipts_ramp_12m_230531_1101/crown-output-apr23_s4.csv"   # '20230606 - Chun-yee Cheng - RE_ QA of ready reckoner Crown receipt calculations.msg'
path_target_low <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_RR_receipts_ramp_48m_230531_1101/crown-output-apr23_s4.csv"   # '20230606 - Chun-yee Cheng - RE_ QA of ready reckoner Crown receipt calculations.msg'
...
```{r echo = FALSE}
  ...
  cc_disposals_delta_actual_high <- run_courts_module_lite(cc_receipts_delta_loaded_list, cc_output_loaded, cc_capacity_loaded, "apr23_central_12m", params)
...
```{r echo = FALSE}
  ...
  cc_disposals_delta_actual_low <- run_courts_module_lite(cc_receipts_delta_loaded_list, cc_output_loaded, cc_capacity_loaded, "apr23_central_48m", params)
