---
title: "Sense checking of outputs from Crown Court module. Comparison with CJST output."
author: "Brian Burton"
date: "03/05/2023"
...
To test how well prisonsreadyreckoner will match the output of a variant
scenario when fed inputs from a base scenario and the additional sitting days or
volumes of ring-fenced disposals from the variant scenario.
...
<!-- # The equivalent of load_crown_data() but for April 2023 data. -->
...
For reference, our ringfenced cases match the October 2022 assumptions and
are as follows:
