...
<!-- Nothing to plot now for the central scenario, which is read in as NA for -->
<!-- efficiency. -->
<!-- ```{r echo=FALSE} -->
...
```{r echo=FALSE}
cc_receipts <- cc_receipts_delta_loaded_list[["apr23_central_12m"]]
...
```{r echo=FALSE}
cc_receipts <- cc_receipts_delta_loaded_list[["apr23_central_36m"]]
...
```{r echo=FALSE}
cc_receipts <- cc_receipts_delta_loaded_list[["apr23_central_48m"]]
...
<!-- efficiency. -->
<!-- # ```{r echo=FALSE} -->
<!-- # mc_disposals <- mc_disposals_delta_loaded_list[["apr23_central"]] -->
<!-- #  -->
...
```{r echo=FALSE}
mc_disposals <- mc_disposals_delta_loaded_list[["apr23_central_12m"]]
...
```{r echo=FALSE}
mc_disposals <- mc_disposals_delta_loaded_list[["apr23_central_36m"]]
...
```{r echo=FALSE}
mc_disposals <- mc_disposals_delta_loaded_list[["apr23_central_48m"]]
