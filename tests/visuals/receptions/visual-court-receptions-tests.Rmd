...
court_disposals_target <- import_s3_file(path_target, range = "population!G5:V54") %>%
...
ggplot2::ggplot() +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = cjst_central_pop, color = "cjst_central_pop", linetype = "cjst_central_pop")) +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = cjst_high_pop, color = "cjst_high_pop", linetype = "cjst_high_pop")) + 
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = cjst_low_pop, color = "cjst_low_pop", linetype = "cjst_low_pop")) +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = prr_baseline_pop, color = "prr_baseline_pop", linetype = "prr_baseline_pop")) +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = prr_pop_det_high, color = "prr_pop_det_high", linetype = "prr_pop_det_high")) +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = prr_pop_det_low, color = "prr_pop_det_low", linetype = "prr_pop_det_low")) +
  ggplot2::scale_linetype_manual(name = " ", values = c("cjst_central_pop" = "solid", "cjst_high_pop" = "solid", "cjst_low_pop" = "solid", "prr_baseline_pop" = "dashed", "prr_pop_det_high" = "dashed", "prr_pop_det_low" = "dashed")) + 
  ggplot2::scale_color_manual(name = " ", values = c("cjst_central_pop" = "black", "cjst_high_pop" = "blue", "cjst_low_pop" = "red", "prr_baseline_pop" = "black", "prr_pop_det_high" = "blue", "prr_pop_det_low" = "red")) +
  ggplot2::labs(title = "axes_title", x = "axes_xlabel", y = "axes_ylabel", caption = "axes_caption") +
  ggplot2::theme_classic()


ggplot2::ggplot(data = pop_table) +
  ggplot2::geom_line(ggplot2::aes(x = date, y = cjst_high_pop_delta, color = "cjst_high_pop_delta", linetype = "cjst_high_pop_delta")) + 
  ggplot2::geom_line(ggplot2::aes(x = date, y = cjst_low_pop_delta, color = "cjst_low_pop_delta", linetype = "cjst_low_pop_delta")) +
  ggplot2::geom_line(ggplot2::aes(x = date, y = prr_pop_det_high_delta, color = "prr_pop_det_high_delta", linetype = "prr_pop_det_high_delta")) +
  ggplot2::geom_line(ggplot2::aes(x = date, y = prr_pop_det_low_delta, color = "prr_pop_det_low_delta", linetype = "prr_pop_det_low_delta")) +
  ggplot2::scale_linetype_manual(name = " ", values = c("cjst_high_pop_delta" = "solid", "cjst_low_pop_delta" = "solid", "prr_pop_det_high_delta" = "dashed", "prr_pop_det_low_delta" = "dashed")) + 
  ggplot2::scale_color_manual(name = " ", values = c("cjst_high_pop_delta" = "blue", "cjst_low_pop_delta" = "red", "prr_pop_det_high_delta" = "blue", "prr_pop_det_low_delta" = "red")) +
  ggplot2::labs(title = "axes_title", x = "axes_xlabel", y = "axes_ylabel", caption = "axes_caption") +
  ggplot2::theme_classic()
...
<!-- Plot: Charlotte baseline and Charlotte scenarios -->

<!-- Plot: `prisonsreadyreckoner` baseline -->

<!-- Low scenario -->

<!-- Plot: `prisonsreadyreckoner` low scenario with baseline -->

<!-- Plot: Difference 1: `prisonsreadyreckoner` difference between low scenario and baseline -->

<!-- Plot: Difference 2: Difference between Charlotte baseline and Charlotte scenarios -->

<!-- Plot: Difference between Difference 1 and Difference 2 -->
...
prison_inflows_low_high <- import_s3_file(path_target, range = "receptions!A5:M90") %>%
  dplyr::mutate(date = lubridate::floor_date(as.Date(`Row Labels`), "month"), .keep = "unused") %>%
...
ggplot2::ggplot() +
  ...
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = prr_pop_det_high, color = "prr_pop_det_high", linetype = "prr_pop_det_high")) +
  ggplot2::geom_line(data = pop_table, ggplot2::aes(x = date, y = prr_pop_det_low, color = "prr_pop_det_low", linetype = "prr_pop_det_low")) +
  ggplot2::scale_linetype_manual(name = " ", values = c("cjst_central_pop" = "solid", "cjst_high_pop" = "solid", "cjst_low_pop" = "solid", "prr_central_pop" = "dashed", "prr_pop_det_high" = "dashed", "prr_pop_det_low" = "dashed")) + 
  ggplot2::scale_color_manual(name = " ", values = c("cjst_central_pop" = "black", "cjst_high_pop" = "blue", "cjst_low_pop" = "red", "prr_central_pop" = "black", "prr_pop_det_high" = "blue", "prr_pop_det_low" = "red")) +
  ggplot2::labs(title = "axes_title", x = "axes_xlabel", y = "axes_ylabel", caption = "axes_caption") +
  ggplot2::theme_classic()
...
The inflow values in s3://alpha-prison-forecasting-data/flowcast/test-files/test-RR_test_230612.xlsx are slightly different to the inflows used in `prisonsreadyreckoner` (see s3://alpha-app-prisonsreadyreckonerapp/2023-04/detailed_apr23_s4_apr23_flat_3m_linear_6m_msim_EDS_change_os_adj_DandS_3m_current_6m_avg_longterm_230426_150555.xlsx)
...
ggplot2::ggplot() +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = prr_orig_inflows_sb1, color = "prr_orig_inflows_sb1", linetype = "prr_orig_inflows_sb1")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = prr_orig_inflows_sb2, color = "prr_orig_inflows_sb2", linetype = "prr_orig_inflows_sb2")) + 
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = prr_orig_inflows_sb3, color = "prr_orig_inflows_sb3", linetype = "prr_orig_inflows_sb3")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = prr_orig_inflows_sb4, color = "prr_orig_inflows_sb4", linetype = "prr_orig_inflows_sb4")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = central_inflows_sb1, color = "central_inflows_sb1", linetype = "central_inflows_sb1")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = central_inflows_sb2, color = "central_inflows_sb2", linetype = "central_inflows_sb2")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = central_inflows_sb3, color = "central_inflows_sb3", linetype = "central_inflows_sb3")) +
  ggplot2::geom_line(data = prison_inflows_comparison, ggplot2::aes(x = date, y = central_inflows_sb4, color = "central_inflows_sb4", linetype = "central_inflows_sb4")) +
  ggplot2::scale_linetype_manual(name = " ", values = c("central_inflows_sb1" = "solid",
                                                        "central_inflows_sb2" = "solid",
                                                        "central_inflows_sb3" = "solid",
                                                        "central_inflows_sb4" = "solid",
                                                        "prr_orig_inflows_sb1" = "dashed",
                                                        "prr_orig_inflows_sb2" = "dashed",
                                                        "prr_orig_inflows_sb3" = "dashed",
                                                        "prr_orig_inflows_sb4" = "dashed"
                                                        )) +
  ggplot2::scale_color_manual(name = " ", values = c("central_inflows_sb1" = "black",
                                                     "central_inflows_sb2" = "red",
                                                     "central_inflows_sb3" = "green",
                                                     "central_inflows_sb4" = "blue",
                                                     "prr_orig_inflows_sb1" = "black",
                                                     "prr_orig_inflows_sb2" = "red",
                                                     "prr_orig_inflows_sb3" = "green",
                                                     "prr_orig_inflows_sb4" = "blue"
  )) +
  ggplot2::theme_classic()
