---
title: "Police charge comparison"
author: "Brian Burton"
date: "05/06/2023"
...
To demonstrate that, when package functions are applied to prison discharge
...
```{r include = FALSE}
  ...
  # inflows as above.
  path_target_central  <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_RR_receipts_check_baseline_230606_1005/crown-output-apr23_s4.csv"
  path_target_ramp_48m <- "s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_RR_receipts_check_48m_230606_1005/crown-output-apr23_s4.csv"
 
 
  
  # Create model receipts delta and that expected from files read in.
