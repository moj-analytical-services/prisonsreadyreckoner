...
* **April23_mid_pandemic_real_for_ready_reckoner.csv** contains entries with a value of zero throughout. It provides a default scenario for `prisonflowcast`. In this default scenario, `prisonflowcast` uses the same number of Crown Court receipts as the April 2023 central projection. See graph *Central projection (i.e. 24-month ramp)*.
