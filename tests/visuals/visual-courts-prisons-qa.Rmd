...
* Comparions are carried out for a **Low** scenario (i.e. low rates of court receipts and disposals) and a **High** scenario (i.e. high rates of court receipts and disposals)
...
* Each scenario relies on two files of input data:
  + **Low**:
    - **Magistrates' court disposals**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_0901/mags_projections/projections_from_mags_model_built_2022_02/2022_06/apr23_test_output_mags_med_RR_test_min.csv
    - **Crown Court receipts**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_baseline_230412_0819/sentencing_outputs_apr23_s4_RR_test_min.xlsx
  + **Central**:
    - **Magistrates' court disposals**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_0901/mags_projections/projections_from_mags_model_built_2022_02/2022_06/apr23_test_output_mags_med.csv
    - **Crown Court receipts**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_baseline_230412_0819/sentencing_outputs_apr23_s4.xlsx
  + **High**:
    - **Magistrates' court disposals**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_0901/mags_projections/projections_from_mags_model_built_2022_02/2022_06/apr23_test_output_mags_med_RR_test_max.csv
    - **Crown Court receipts**: s3://alpha-app-criminal-scenario-tool/developmentFolder/Dev_apr23_v1/model_outputs/sensitivity_baseline_230412_0819/sentencing_outputs_apr23_s4_RR_test_max.xlsx
...
**Graph 2** shows the divergences of the **High** and **Low** populations from the Central populations (i.e. the dashed black line in **Graph 1** for `prisonflowcast` and the solid black line in **Graph 1** for the CJS Modelling team)
...
* **Low**, **Central** and **High** scenarios takes determinate sentence prison receptions from file s3://alpha-prison-forecasting-data/flowcast/test-files/test-RR_test_230612.xlsx.
