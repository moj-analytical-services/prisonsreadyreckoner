...
test_that("calculate_inflows_det_delta() will correctly apply a linear model to generate a prison reception forecast", {
  ...
  # Separately construct a prediction using package functions.
  lm_receptions <- prisonsreadyreckonerupdater::estimate_lm_receptions(model_data)
  reception_rates <- prisonsreadyreckonerupdater::make_reception_rates_table(lm_receptions)
