...
`prisons-ready-reckoner-app` and as a stand-alone package that may be invoked for
batch scenario work in conjunction with other MoJ products.
...
renv::install("git@github.com:moj-analytical-services/prisonsreadyreckonerupdater.git@v1.0.0")

# Install prisonsreadyreckoner. At the time of writing, the current version of
# prisonsreadyreckoner is v1.0.0 but you should check that a higher version is
...
Please note that prisonsreadyreckoner requires at least `tidyselect` v1.2.0.
...
scenariosFile: "scenarios-20230712-OFFICIAL.yaml"
...
shiny_1_0_0:
  id: 1
  description: >-
    Basic, initial scenario accompanying the Shiny app release v1.0.0.
  modelVersion: v1.0.0  # Version of the commissions repository
  assumptions: NA
  params: params-20230712-shiny_1_0_0-OFFICIAL.yaml
  files: files-20230712-shiny_1_0_0-OFFICIAL.yaml
  startup: NA
  ...
  comments: >-
    ...
    prisons-ready-reckoner-app, v1.0.0.
  refresh: TRUE
  dateRun: NA
  user: NA
  sha: NA
...
```yaml
# Parameters used for the first formal release of the Shiny app, August 2023,
# prisons-ready-reckoner-app v1.0.0.
...
lever_police_charges_scenario: "central"
...
# Magistrates' courts
police_charges_mc_scenarios:
  central: "apr23_central"
...
remand_rates: !expr 'c(receipts = 0.187429985453694, disposals = 0.475353729743915)'   # '20230712 - To Jordan Carroll - RE_ Remand model comparison.msg'
...
mc_remand_lookup: !expr 'tibble::tribble(~disposal_type, ~remanded, "mc_ind", TRUE, "mc_tew", TRUE, "mc_sm", FALSE, "mc_snm", FALSE)'   # '20230705 - Jordan Carroll - RE_ Sitting Day Remand Impact Method.msg'
...
police_charges_mc_file:
  description: >-
    "Magistrates' court receipts for various police charge scenarios""
  origin: shiny
  dataFile: "'2023-04/[020623_mags_sensitivity_output.xlsx]Sheet1'"
  dataRegister: NA
  comments: "202306026 - XXX - RE_ mags outputs template.eml"

police_charges_cc_files__central:
  description: >-
    Records the total number of Crown Court receipts used as a baseline in the
    April 2023 projections. Includes background values from various sources, and
    an increase in charge numbers over a 24-month period. It has non-zero values
    throughout.
  origin: shiny
  dataFile: "2023-04/April23_mid_pandemic_real_for_ready_reckoner.csv"
  dataRegister: NA
  comments: "20230525 - XXX - RE_ Next steps on the CJS ready reckoner.eml"

police_charges_cc_files__ramp_12m:
  description: >-
    Records how Crown Court receipts would change if police charge numbers were
    increased over a 12-month period instead of over a 24-month period. Records
    differences relative to the values in
    April23_mid_pandemic_real_for_ready_reckoner.csv.
  origin: shiny
  dataFile: "2023-04/April23_mid_pandemic_real_12m_ramp_for_ready_reckoner.csv"
  dataRegister: NA
  comments: "20230525 - XXX - RE_ Next steps on the CJS ready reckoner.eml"

police_charges_cc_files__ramp_36m:
  description: >-
    Records how Crown Court receipts would change if police charge numbers were
    increased over a 36-month period instead of over a 24-month period. Record
    differences relative to the values in
    April23_mid_pandemic_real_for_ready_reckoner.csv.
  origin: shiny
  dataFile: "2023-04/April23_mid_pandemic_real_36m_ramp_for_ready_reckoner.csv"
  dataRegister: NA
  comments: "20230525 - XXX - RE_ Next steps on the CJS ready reckoner.eml"

police_charges_cc_files__ramp_48m:
  description: >-
    Records how Crown Court receipts would change if police charge numbers were
    increased over a 48-month period instead of over a 24-month period. Records
    differences relative to the values in
    April23_mid_pandemic_real_for_ready_reckoner.csv.
  origin: shiny
  dataFile: "2023-04/April23_mid_pandemic_real_48m_ramp_for_ready_reckoner.csv"
  dataRegister: NA
  comments: "20230525 - XXX - RE_ Next steps on the CJS ready reckoner.eml"
...
cc_output_file:
  description: >-
    ...
    central scenario.
  origin: shiny
  dataFile: "2023-04/crown-output-apr23_s4.csv"
  dataRegister: NA
...
cc_capacity_file:
  description: >-
    ...
    scenario.
  origin: shiny
  dataFile: "2023-04/sd_htpsd_adjusted_apr23_s4.csv"
  dataRegister: NA
  comments: "20230502 - XXX - RE_ Testing our assumptions with a second Crown Court scenario_.msg"

ringfenced_lookup_file:
  description: >-
    A look-up table for which Crown Court 
  origin: shiny
  dataFile: "2023-04/ringfenced-lookup-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
...
sentencing_rates_file:
  description: >-
    ...
    receptions.
  origin: shiny
  dataFile: "2023-04/reception-rates-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
prison_inflows_file:
  ...
  origin: shiny
  dataFile: "'2023-04/[detailed_apr23_s4_apr23_flat_3m_linear_6m_msim_EDS_change_os_adj_DandS_3m_current_6m_avg_longterm_230426_150555.xlsx]Sheet1'"
  dataRegister: NA
...
profiles_file:
  ...
  origin: shiny
  dataFile: "2023-04/profiles-det-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
recall_file:
  ...
  origin: shiny
  dataFile: "'2023-04/[recall_excl_PSS_output_apr23_s4_apr23_flat_3m_linear_6m_msim_EDS_change_os_adj_DandS_3m_current_6m_avg_longterm_230426_150555.xlsx]Sheet1'"
  dataRegister: NA
  comments: "20230505 - XXX - Updated prison projections .msg"
...
licence_profiles_file:
  ...
  origin: shiny
  dataFile: "2023-04/adjusted_license_profile.csv"
  dataRegister: NA
...
gender_splits_file:
  ...
  origin: shiny
  dataFile: "2023-04/gender-splits-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
tot_pop_file:
  ...
  origin: shiny
  dataFile: "2023-04/populations_apr23_s4_apr23_flat_3m_linear_6m_msim_EDS_change_os_adj_DandS_3m_current_6m_avg_longterm_230426_150555.xlsx"
  dataRegister: NA
...
capacity_file:
  ...
  origin: shiny
  dataFile: "2023-04/May-23 Supply Forecasts_V1.5_Shared.xlsx"
  dataRegister: NA
...
recall_rate_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/recall_rate_b.csv"
  dataRegister: NA
...
time_served_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/historical-time-served-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
sitting_days_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/sitting_days_actuals.csv"
  dataRegister: NA
...
prison_population_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/historical-prison-population-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
prison_inflows_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/historical-prison-inflows-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: Generated with the prisonsreadyreckonerupdater package.
...
police_charges_hist_file:
  ...
  origin: shiny
  dataFile: "2023-04/historical-police-charges-20230502-shiny-v0.0.0-OFFICIAL.csv"
  dataRegister: NA
  comments: >-
