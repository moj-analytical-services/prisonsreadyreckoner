...
lever_extra_cc_sitting_days               The number of Crown Court sitting days
                                          ...
                                          the Shiny app is expressed on a per
                                          year basis and divided by 12 on
                                          capture).
  
lever_extra_cc_sitting_days_impact_date   The impact date for the sitting day
                                          lever, e.g. `"2023-06-01"`.
                                        
lever_extra_inflows_det                   A named vector of additional inflows
                                          to the determinate sentence prison
...
lever_profiles_recall_stretch_factors     As lever_profiles_det_stretch_factors
                                          but with respect to profiles of time
                                          served by determinate sentence
                                          offenders while on recall.
                                        
lever_profiles_recall_stretch_impact_date The impact date for the determinate
                                          sentence recall profile lever.
...
recall_rate_hist_file                   Historical recall rates, formulated in
                                        the same way as `lever_recall_rate`.
