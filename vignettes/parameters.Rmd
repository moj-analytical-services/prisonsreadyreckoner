...
lever_police_charges_scenario           The name of the police charge scenario
                                        defining court receipt volumes. See
...
--police_charges_mc                     Date for `police_charges_mc_file`
...
police_charges_mc_file                  The path to a file holding receipt
                                        volumes in the magistrates' court for
                                        various police charge scenarios.
                                        
police_charges_mc_sheet                 The name of the sheet in
                                        `police_charges_mc_file`
                                        where magistrates' court police charge
                                        scenario data are to be found.
                                        
police_charges_mc_scenarios             A named list of police charge scenarios
                                        for the magistrates' court. Keys are the
                                        values acceptable for the
                                        `lever_police_charges_scenario` lever.
                                        Values are scenario names as they appear
                                        in `police_charges_mc_file`.
                                        
police_charges_cc_files                 A named list of paths for police charge
                                        scenarios for the Crown Court. Keys are
                                        the values acceptable for the
                                        `lever_police_charges_scenario` lever.
                                        Values are paths to the relevant files.
...
ringfenced_lookup_file                  Path to a look-up table identifying
                                        ...
                                        serviced immediately upon receipt).
