...
The user can vary the time served in prison by determinate sentence recalled prisoners relative to an average value of recall time served calculated from historical data. Different changes can be specified for each [Sentence band][sentence-bands], and will affect offenders who entered prison in the forecast period and who were recalled to prison after a specified **Impact date**.
