...
population will change in future. These projections are influenced by six
**Levers**.

```{r, echo=FALSE}
mojflowchart::flowchart("prisonsreadyreckoner-flow-chart.mmd", height=10, width=2)
```
...
who enter prison after April 2023 and who are subsequently released on licence.
...
Different factors can be specified for each [Sentence band][sentence-bands], and will affect
licensees who are recalled after a specified **Impact date**.
