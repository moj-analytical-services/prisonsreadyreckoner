...
### **Lever 1**: Vary number of court cases {#lever-vary-number-of-court-cases}
...
See functions `load_police_charges_cc_data)` and
...
percentages can be specified for each [Sentence band][sentence-bands], and changes
will come into effect on a specified **Impact date**. Note that this lever affects
only offenders who enter prison in the forecast period and who are subsequently
released on licence.

### Lever 6: Vary time served on recall by determinate sentence offenders {#lever-vary-time-served-on-recall-by-determinate-sentence-offenders}

The user can vary the time served in prison by determinate sentence recalled
prisoners relative to an average value of recall time served calculated from
historical data. Different changes can be specified for each
[Sentence band][sentence-bands], and will affect offenders who entered prison in the
forecast period and who were recalled to prison after a specified **Impact date**.
